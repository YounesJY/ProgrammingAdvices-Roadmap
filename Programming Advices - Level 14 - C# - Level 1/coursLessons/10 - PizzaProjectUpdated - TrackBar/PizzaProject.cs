...
namespace PizzaProject
{
    public partial class PizzaProject : Form
    {
        ...
        private short GetTotalPrice()
        {
            ...
            return (short)(tbQuantity.Value * singleUnitPrice);
        }
        ...
        {
            lblQuantity.Text = tbQuantity.Value.ToString();
            orderSummaryQuantity.Text = tbQuantity.Value.ToString();
        }
