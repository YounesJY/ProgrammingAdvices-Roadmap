...
namespace Project__01___Copy
{
    public partial class frmMessageBox : Form
    {
        ...
        {
            if (MessageBox.Show("Are you sure to make this operation ?", "Verification", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult)
                MessageBox.Show("Operation done successfuly");
        }
    }
}
