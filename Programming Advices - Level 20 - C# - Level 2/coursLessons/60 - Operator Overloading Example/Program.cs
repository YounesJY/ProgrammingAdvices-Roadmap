...
class Program
{
    static void Main()
    {
        ...
        /*
            By default, == and != operators compare the references of the objects, not their values.
        but since we have overloaded these operators, they now compare the values of the Point objects instead of their references.
            in Java , the == operator compares the references of objects, while the equals() method compares their values. 
        In C#, we can overload the == and != operators to compare the values of objects instead of their references.
        */
