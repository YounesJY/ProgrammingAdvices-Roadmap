...
namespace SendDataBackToFromUsingDelgate
{
    ...
    {
        /*
            Declare a delegate, a delegate must include the minimum necessary informations (parameters) that handlers/subscribers can decide what to do based on
        ...
        */
        ...
        private void SendDataBack_Click(object sender, EventArgs e)
        {
            ...
            // The ".?" is a shorthand to check for the existance/absence of any handlers/subscribers/listeners for this event
