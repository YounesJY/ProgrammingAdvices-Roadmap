...
SELECT TRIM(Name) AS NameWithNoSpaces
FROM dbo.Employees2
GO
--- -------------------------------------------
--- -------------------------------------------