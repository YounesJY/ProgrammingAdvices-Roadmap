...
public class Example
{
    public static void Main()
    {
        ...
        DataSet enterpriseDataSet = new DataSet("enterpriseDataSet");
        ...
        foreach (DataRow recordRow in enterpriseDataSet.Tables["employeesDataTable"].Rows)
        {
            Console.WriteLine($@"
                                ID      : {recordRow["ID"]}
                                Name    : {recordRow["Name"]} 
        ...
        foreach (DataRow recordRow in enterpriseDataSet.Tables["departmentsDataTable"].Rows)
        {
            //Using Field Name
            Console.WriteLine($@"
                                DepartmentID : {recordRow["DepartmentID"]}
